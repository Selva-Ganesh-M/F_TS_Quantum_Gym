...
const HomeSidebar = (props: Props) => {
    ...
    return (
        <>
            <div className={`${toggler.homeSidebar && isSmallScreens ? "left-0" : "left-[-250px]"} transition-all h-full p-[1em] w-[250px] absolute bg-pink-900 top-0 text-white z-[999]`}>
                {/* header */}
                ...
                <div
                    ...
                    <div
                        ...
                        className='p-2 hover:bg-slate-100 flex items-center gap-3 text-md rounded-t-xl cursor-pointer'>
                        <GoGlobe /> Global
                    </div>
                    <div
                        onClick={() => handleRedirect(EHomeRoutes.events)}
                        className='p-2 hover:bg-slate-100 flex items-center gap-3 text-md cursor-pointer'>
                ...
                <div
                    ...
                    <div className='p-2 hover:bg-slate-100 flex items-center gap-3 text-md cursor-pointer'>
                        <FaHome /> Home
                    </div>
                    <div className='p-2 hover:bg-slate-100 flex items-center gap-3 text-md cursor-pointer'>
                    ...
                    <div className='p-2 hover:bg-slate-100 flex items-center gap-3 text-md rounded-b-xl cursor-pointer'>
